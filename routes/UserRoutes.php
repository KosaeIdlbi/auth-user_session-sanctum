...
use App\Http\Controllers\Api\User\Auth\Web\LoginController;
use App\Http\Controllers\Api\User\Auth\Web\LogoutController;
...
Route::middleware(["auth:user", "NotVerify:user"])->prefix("user/verify/")->as("user.verify.")->group(function () {
...
Route::middleware(["auth:user", "Verify:user"])->prefix("user/")->as("user.")->group(function () {
